...
export function ReceiptScannerModal({ isOpen, onClose, onScanned }: ReceiptScannerModalProps) {
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-800 bg-slate-950/60">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Scan receipts from restaurants, fuel, groceries, or stores</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="p-5 overflow-y-auto space-y-4">
          ...
          {!previewUrl ? (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-3 rounded-2xl bg-sky-500/10 text-sky-400 flex items-center justify-center group-hover:scale-110 transition border border-sky-500/20">
                <Upload className="w-7 h-7" />
              </div>
              <p className="text-sm font-medium text-slate-200">Select or drop receipt image here</p>
            ...
            <div className="space-y-4">
              ...
              <div className="relative rounded-xl overflow-hidden border border-slate-700/60 bg-black max-h-56 flex items-center justify-center">
                ...
                />
                {isScanning && (
                  <div className="absolute inset-0 bg-sky-900/20 flex flex-col items-center justify-center">
                    <motion.div
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    <div>
                      ...
                      <strong className="text-slate-100 text-sm font-mono">
                  ...
                  {scanResult.note && (
                    <div className="pt-1 text-[11px] text-slate-400 border-t border-slate-800">
                      <strong>Items Note:</strong> {scanResult.note}
                    </div>
                  )}
                </motion.div>
              )}
        ...
        <div className="flex items-center justify-end gap-3 px-5 py-3 border-t border-slate-800 bg-slate-950/60">
          ...
          <button
            ...
            onClick={handleApply}
            className="px-5 py-2 text-xs font-semibold rounded-xl bg-gradient-to-r from-sky-500 to-cyan-500 text-slate-950 hover:from-sky-400 hover:to-cyan-400 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5 shadow-lg shadow-sky-500/20"
          >
